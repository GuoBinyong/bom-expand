interface Storage {
  ...
  setAnyItem(keyName:string, anyItem:any, replacer?:(this: any, key: string, value: any) => any, space?: string | number): string;
  setAnyItem(keyName:string, anyItem:any, replacer?: (number | string)[] | null, space?: string | number): string;
   ...
   * @returns any
   */
  getParsedItem(keyName:string, reviver?: (this: any, key: string, value: any) => any):any;
